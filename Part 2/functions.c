...
/* Function that removes consecutive duplicate coordinates , transforms multi-dimensional grid curve into one-dimensional 
...
// Auxilary function that checks out if a curve is assigned as a centroid
int is_centroid(node **centroids, node *new, int size)
{
	int i;
