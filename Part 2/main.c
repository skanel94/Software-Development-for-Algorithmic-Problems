...
// $./cluster –i <input file> –c <configuration file> -o <output file> -d <metric> [όπου metric Frechet ή DTW για ομάδες 2 ατόμων]

//compile test command: gcc -o test main.c functions.c clustering.c hashtable.c preprocessing.c structs.c metric_functions.c -lm
//run test command: ./clustering -i medium_dataset -o out -d DTW -c cluster.conf
